...
DATASET_PATH = os.path.join(TRAINING_DATA_PATH, "eval_uniform_1M.parquet")
...
def objective(trial):
    ...
    w0 = trial.suggest_float("w0", 30.0, 100.0)
    ...
    w_hidden = trial.suggest_float("w_hidden", 0.8, 5.0)
